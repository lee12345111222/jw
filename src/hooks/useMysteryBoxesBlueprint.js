...
import { MysteryBoxesBlueprint as ContractAddress } from '../constant/env/index';
import ContractAbi from '../constant/abi/MysteryBoxesBlueprint.json';
import { httpProvider, supported_chains } from '@/constant/env/index';

export default function useMysteryBoxesBlueprint() {
