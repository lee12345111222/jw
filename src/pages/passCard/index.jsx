...
import { confirmTransaction, sleep } from '@/utils/common';
...
// import openseaIcon from '@/assets/icon/open-opensea.svg';
...
export default function PassCard() {
  ...
  const [currentSupply, setcurrentSupply] = useState([338, 36, 24, 20]);
      ...
      <Flex jc="center" gap="56px">
        <Flex fd="column" gap="16px">
          ...
          <div className={cx('buy-btn-container')}>
            ...
            {/* <a
              href="/redirect.html#https://opensea.io/collection/playerone-mintpass"
              target="_blank"
              rel="noreferrer"
              className={cx('open-opensea')}
            >
...
const Card = ({
  ...
  const handleBuy = useCallback(async () => {
    if (!count) {
      return message.info('Cannot be 0');
    }
